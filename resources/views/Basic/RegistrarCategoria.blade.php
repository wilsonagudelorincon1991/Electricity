        ...
        <div class="row">
            <div class="col s8">
                <div class="card" style="padding: 5px">
                    <h4 align="center">Gestionar Categoria</h4>
                    <div class="row">
                    ...
                    <div class="col s4">
                        <div class="card" style="padding: 5px">
                            ...
                            <div class="input-field col s12">
                                ...
                                <label id="lbNombre" for="txtNombreBuscar">Nombre de la categoria</label>
                            </div>
...
<script src="../../public/js/Electricity/Basic/registrar.categoria.js" type="text/javascript"></script>