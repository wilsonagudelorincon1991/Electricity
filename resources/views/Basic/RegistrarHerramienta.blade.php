        ...
        <div class="row">
            <div class="col s8">
                <div class="card" style="padding: 5px">
                    <h4 align="center">Gestionar Herramienta</h4>
                        <div class="col s6">
                    ...
                    <div class="col s4">
                        <div class="card" style="padding: 5px">
                            ...
                            <div class="input-field col s12">
                                ...
                                <label id="lbNombre" for="txtNombreBuscar">Nombre de la herrmienta</label>
                            </div>
...
<script src="../../public/js/Electricity/Basic/registrar.herramienta.js" type="text/javascript"></script>
