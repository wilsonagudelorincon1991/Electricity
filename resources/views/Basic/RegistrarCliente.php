...
<div style="padding: 1%">
        <div class="row">
            <div class="col s8">
                <div class="card" style="padding: 5px">
                    <h4 align="center">Gestionar cliente</h4>
                    <div class="row">
                        <div class="col s6">
                            ...
                            <div class="input-field col s12">
                                <!--<i class="mdi-image-timer-auto prefix"></i>-->
                                <input id="txtNombre" type="text" data-form="nombres">
                        ...
                        <div class="col s6">
                            ...
                            <!--<button id="btnRegistrar" class="btn" style="margin-left: 30%; margin-top:5%">Registrar</button> -->
                        </div>
                    </div>
                    <div class="row">
                        <div class="col s4">
            ...
            <div class="col s4">
                <div class="card" style="padding: 5px">
                    ...
                    <div class="input-field col s12">
                        ...
                        <label id="lbNombre" for="txtNombreBuscar">Nombre del cliente</label>
                    </div>
        ...
        <script src="../../public/js/Electricity/Basic/registrar.cliente.js" type="text/javascript"></script>
