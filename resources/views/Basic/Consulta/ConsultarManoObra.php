<div style="margin-left: 2%; margin-right: 2%">
    <div class="card" style="padding: 20px">
        <h5 style="margin-left:10px" align="center">Buscar Mano de Obra</h5>
        <div  class="row">
            <div class="input-field col s4" style="margin-left: 25%">
                <!--<i class="mdi-action-perm-identity prefix"></i>-->
                <input id="txtNombre" type="text" class="validate">
                <label for="txtNombre">Buscar Mano de Obra</label>
            </div>
...
<script src="../../public/js/Electricity/Basic/Consulta/consultar.mano.obra.js"></script>
